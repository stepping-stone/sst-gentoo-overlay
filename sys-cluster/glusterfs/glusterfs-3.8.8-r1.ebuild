...
inherit autotools elisp-common eutils multilib python-single-r1 systemd versionator
...
IUSE="bd-xlator crypt-xlator debug emacs +fuse +georeplication glupy infiniband qemu-block rsyslog static-libs +syslog systemtap test +tiering vim-syntax +xml +libtirpc"
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-3.8.8-libtirpc.patch"
)
